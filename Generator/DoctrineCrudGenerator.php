...
namespace Jlbs\AdminBundle\Generator;
...
class DoctrineCrudGenerator extends BaseDoctrineCrudGenerator
{
    ...
    public function generate(BundleInterface $bundle, $entity, ClassMetadataInfo $metadata, $format, $routePrefix, $needWriteActions, $forceOverwrite)
    {
        ...
        $this->actions = $needWriteActions ? array('index', 'list', 'show', 'new', 'delete') : array('index','list', 'show');
    ...
    protected function getRecordActions()
    {
        return array_filter($this->actions, function($item) {
                return in_array($item, array('show', 'new','delete'));
            });
    }
}
